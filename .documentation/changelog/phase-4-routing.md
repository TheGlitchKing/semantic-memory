---
title: Phase 4 — Routing + Transitions
tier: reference
domains: [changelog]
audience: [developers]
tags: [phase-4, routing, modes, transitions, changelog]
status: active
last_updated: '2026-04-23'
version: '0.2.3'
purpose: research-mode + outage-silence skills, /mode, /vault, mode-aware hooks, transition capture
load_priority: 4
---
